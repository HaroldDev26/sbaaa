...
class _FieldEventRecordScreenState extends State<FieldEventRecordScreen> {
  ...
  Future<void> _loadSavedResults() async {
    try {
      ...
      final docRef = _firestore
          ...
          .doc('field_${widget.eventName}_${widget.groupName}');
  ...
  List<Map<String, dynamic>> _getRankedAthletes() {
    ...
    rankedAthletes = _scoringService.sortAndRankFieldEventAthletes(
        rankedAthletes,
  ...
  Widget build(BuildContext context) {
    if (_isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text('${widget.eventName} ${widget.groupName} - 成績紀錄'),
